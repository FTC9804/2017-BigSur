...
@TeleOp(name = "TeleOpV7VariableBothVariable", group = "LA Championships")
//@Disabled
public class BigSurTeleopx2DriveBothIntakes extends OpMode {
    ...
    public void loop() {
        ...
        if (!capBallState) {
            ...
            else if (gamepad2.right_trigger > 0.6) { //triggers act like an axis, so to make them behave like buttons
...
//        rpmGain = (desiredRPMGain/150)*deltaRPM + desiredRPMGain;
            ...
            //our drivers only want the ability to retract the cap grabber servos,
            // not push them out during teleop, so this allows them to either bring them in
            // or hold them steady.
