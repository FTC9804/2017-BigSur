 ...
 * Purpose of the code is to allow the ability to tune left beacon pusher servo
 */

@Autonomous(name = "left beacon", group = "ServoTuning")
//@Disabled
public class TuneLeftBeacon extends FunctionsForLA {

    //OVERALL VARIABLES
    double timeOne, timeTwo, beaconStartPosition = 0, beaconEndPosition = 1;
    int stepInMenu = 1;
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (this.opModeIsActive()) {
            if (gamepad1.x) {
                beaconPusherLeft.setPosition(beaconStartPosition);
            }
            else if (gamepad1.b) {
                beaconPusherLeft.setPosition(beaconEndPosition);
            }
        }
    }
